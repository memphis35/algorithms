...
class HighArray {
    ...
    /**
     * @homework 2.1. Добавьте в класс HighArray из програмы highArray.java (листинг 2.3) метод
    ...
    /**
     * @homework 2.2. Измените метод из проекта 2.1 так, чтобы элемент с наибольшим ключом не
